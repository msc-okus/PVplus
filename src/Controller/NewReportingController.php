...
class NewReportingController extends AbstractController
{
    use G4NTrait;
    ...
    ): Response
    {
        ...
        return $this->render('newReporting/_inc/_listReports.html.twig', [
     ...
     * @throws InvalidArgumentException
     */
    #[Route(path: '/newReporting/create', name: 'app_newReporting_create', methods: ['GET', 'POST'])]
    public function createReportnew(
        Request $request,
        PaginatorInterface $paginator,
        ReportsRepository $reportsRepository,
        AnlagenRepository $anlagenRepo,
    ...
    #[Route(path: '/newReporting/edit/{id}', name: 'app_newReporting_edit')]
    public function newEdit($id,ReportsRepository $reportsRepository, Request $request, EntityManagerInterface $em): Response
    {
        $report = $reportsRepository->find($id);
        $form = $this->createForm(ReportsFormType::class, $report);
        $form->handleRequest($request);
        ...
        return $this->render('newReporting/'.$template, [
            'reportForm'    => $form,
            'report'        => $report,
            'anlage'        => $report->getAnlage()
        ]);
    ...
    #[Route(path: '/reporting/list/{anlageId}', name: 'app_reporting_list_anlId')]
    public function list(ReportsRepository $reportsRepository, int $anlageId, AnlagenRepository $anlagenRepository): Response
    {


        $reports = $reportsRepository->findByAnlageId($anlageId);

        return $this->render('newReporting/list.html.twig', [
            'reports' => $reports,
            'stati'      => self::reportStati(),
