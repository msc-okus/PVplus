...
class Case5Controller extends BaseController
{
    ...
    #[Route(path: '/dashboard/plants/case5/edit', methods: 'GET', name: 'app_dashboard_plant_case5_edit')]
    ...
    #[Route(path: '/dashboard/plants/case5/delete', methods: 'GET', name: 'app_dashboard_plant_case5_delete')]
