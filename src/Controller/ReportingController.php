...
class ReportingController extends AbstractController
{
    ...
    public function showReportAsPdf($id, Request $request, ReportService $reportService, ReportsRepository $reportsRepository, NormalizerInterface $serializer,  ReportsEpcNewService $epcNewService, PdfService $pdf)
    {
     ...
     */
    public function showReportAsHtml($id, ReportsRepository $reportsRepository, Request $request, ReportService $reportService,  NormalizerInterface $serializer,  ReportsEpcNewService $epcNewService){
        $report = $reportsRepository->find($id);
        if ($report) {
            /** @var AnlagenReports|null $report */
            $session=$this->container->get('session');
