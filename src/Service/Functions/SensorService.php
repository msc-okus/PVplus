    ...
    private function corrIrr(?array $oldWeather, ?array $newWeather, ?array $sensorData, TicketDate $ticketDate): array
    {
        ...
        if (!$newWeather['irrEast'] && !$newWeather['irrWest']) {
            ...
            if ($newWeather['irrModul'] && $newWeather['irrModul'] > 0) {
                ...
                $sensorData['irr1']    = $ticketDate->getTicket()->getScope() == '10' ? $sensorData['upperIrr'] : $oldWeather['upperIrr'];
                $sensorData['irr2']    = $ticketDate->getTicket()->getScope() == '20' ? $sensorData['upperIrr'] : $oldWeather['upperIrr'];
                $sensorData['irr3']    = $ticketDate->getTicket()->getScope() == '30' ? $sensorData['upperIrr'] : $oldWeather['upperIrr'];
            }
        } else {
