...
class ChartService
{
     ...
     * AC - Inverter
     */
    private function getGroupPowerDifferenceAC(Anlage $anlage, $from, $to):?array
    {
        $conn = self::getPdoConnection();
        $dataArray = [];
        $acGroups = $anlage->getGroupsAc();
     ...
     * AC - Actual, Groups
     */
    private function getActVoltageGroupAC(Anlage $anlage, $from, $to, int $group = 1):?array
    {
        $conn = self::getPdoConnection();
        $dataArray = [];
        $acGroups = $anlage->getGroupsAc();
     ...
     * AC - Actual, Groups
     */
    private function getActCurrentGroupAC(Anlage $anlage, $from, $to, int $group = 1):?array
    {
        $conn = self::getPdoConnection();
        $dataArray = [];
        $acGroups = $anlage->getGroupsAc();
     ...
     * AC - Actual, Groups
     */
    private function getActFrequncyGroupAC(Anlage $anlage, $from, $to, int $group = 1):?array
    {
        $conn = self::getPdoConnection();
        $dataArray = [];
        $acGroups = $anlage->getGroupsAc();
     ...
     */
    private function getActExpGroupDC(Anlage $anlage, $from, $to, $group = 1):array
    {
     ...
     *  // irradiation
     */
    private function getIrradiation(Anlage $anlage, $from, $to, string $mode = 'all')
    {
        $conn = self::getPdoConnection();
        $dataArray = [];
     ...
     * AC - Actual, Groups
     */
    private function getReactivePowerGroupAC(Anlage $anlage, $from, $to, $group = 1)
    {
        $conn = self::getPdoConnection();
        $dataArray = [];
        $acGroups = $anlage->getGroupsAc();
