...
use App\Service\Forecast\DatFileReaderService;
use App\Service\TicketsGeneration\TicketsGeneration;
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($anlageId and $anlage) {
            ...
            if (count($this->datFileReaderService->current()) > 1) {
                ...
                $reg_data = new TicketsGeneration\Forecast\APINasaGovService($input_gl, $input_gb, $startapidate, $endapidate);
                $dec_data = new TicketsGeneration\Forecast\ForcastDEKService($input_gl, $input_gb, $input_mer, $input_mn, $input_ma, $input_ab, $this->datFileReaderService->current());
